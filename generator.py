...
def main():
    ...
    # Create instance of the noise generator
    generator = InverseSystemNoiseGenerator(
        SRIM_plant_system.A, 
        SRIM_plant_system.B, 
        SRIM_plant_system.C, 
        SRIM_plant_system.D, 
    ...
    al.save_audio(uncontrolled_output, sampling_rate, 'PlantSystemOutput')
